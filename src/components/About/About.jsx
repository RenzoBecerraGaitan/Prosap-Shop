...
export default function About() {
    return (
        <>
                <div className="about-us-container mb-5 mt-5">
                    <div className="image-and-content row animate__animated animate__bounce">
                        <div className="col">
                            <div className="left-section">
                                ...
                                <p className="text-center"><b>En nuestra tienda en línea, nos esforzamos por brindar productos de alta calidad a precios asequibles. Fundada en 2023, nuestra misión es hacer que la experiencia de compra en línea sea fácil, conveniente y agradable para nuestros clientes.</b></p>
                        ...
                        <div className="col">
                            ...
                            <a href="/" className="btn btn-block btn-danger"><i className="bi bi-backspace"></i> Volver a Home</a>
                        </div>
                    </div>
                </div>
        </>
